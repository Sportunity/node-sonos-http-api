...
// Create backup preset to restore this player
  ...
  if (player.coordinator.uuid == player.uuid) {
    ...
    backupPreset.elapsedTime = Math.round(parseInt(elapsedTime) + parseInt(duration) / 1000) ;
  }
...
relevantBackupPreset.elapsedTime = Math.round(parseInt(elapsedTime) + parseInt(duration) / 1000) ;
      }
    }
